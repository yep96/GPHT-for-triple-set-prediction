...
from models import HAKE, KGEModel, ModE
...
def parse_args(args=None):
    ...
    parser.add_argument('--max_steps', default=64_0000, type=int)

    parser.add_argument('--save_checkpoint_steps', default=10000, type=int)
    parser.add_argument('--valid_steps', default=1_0000, type=int)
    ...
    parser.add_argument('-perfix', type=str, default='', help='perfix of train and test')
...
def main(args):
    ...
    if args.do_train:
        ...
        for step in range(init_step, args.max_steps+1):
            ...
            if args.do_test and step % args.valid_steps == 0 and step > init_step + args.valid_steps / 2:
                args.valid_steps *= 2
                print('\r', end='')
